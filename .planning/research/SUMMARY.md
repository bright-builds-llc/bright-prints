...
**Stack:** Use a single Next.js web app on Railway with Railway Postgres and Prisma for runtime data, repo-backed schemas for public print/generator content, and a separate generator worker for parametric `3mf` creation.
...
- Make generator architecture a first-class platform, not a one-off feature.
